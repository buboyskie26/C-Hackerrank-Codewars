...
namespace BuildPrac.CleanUpMethods
{
    ...
    {
        public DecreaseNumberOfParameters(string name, string homeAddress,
        ...
        public void SaveHomeAddress(string name, string homeAddress,
            string country, string email, string fileLocation, string telephone)
        {
